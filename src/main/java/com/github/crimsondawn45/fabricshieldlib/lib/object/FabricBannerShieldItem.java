...
public class FabricBannerShieldItem extends Item implements FabricShield {
     ...
     */
    public FabricBannerShieldItem(net.minecraft.item.Item.Settings settings, int coolDownTicks, int enchantability, Item... repairItems) {
        super(settings);
     ...
     */
    public FabricBannerShieldItem(net.minecraft.item.Item.Settings settings, int coolDownTicks, ToolMaterial material) {
     ...
     */
    public FabricBannerShieldItem(net.minecraft.item.Item.Settings settings, int coolDownTicks, int enchantability, TagKey<Item> repairItemTag) {
        super(settings);
     ...
     */
    public FabricBannerShieldItem(net.minecraft.item.Item.Settings settings, int coolDownTicks, int enchantability, ShieldEntityModel modelFabricShield, SpriteIdentifier baseTexture, SpriteIdentifier nopatternTexture, Collection<TagKey<Item>> repairItemTags) {
        super(settings);
